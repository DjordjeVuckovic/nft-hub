export type EventType = 'UserRegistered' | 'NFTMinted' | 'UserBlacklisted' | 'UserRemovedFromBlacklist' | 'FeesUpdated';
...
export type ContractEvent = UserRegisteredEvent | NFTMintedEvent | UserBlacklistedEvent | UserRemovedFromBlacklistEvent | FeesUpdatedEvent;
